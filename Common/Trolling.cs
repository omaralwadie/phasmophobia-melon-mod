...
namespace C4PhasMod
{
    class Trolling
    {
        ...
        {
            MelonLogger.Msg("Troll->Hunt: Triggered", 1);
            CloseAllExitDoors();
        ...
        {
            MelonLogger.Msg("Troll->Idle: Triggered", 1);
            Main.ghostAI.field_Public_Player_0 = null;
        ...
        {
            MelonLogger.Msg("Troll->Appear: Triggered", 1);
            PhotonView photonView = Main.ghostAI.field_Public_PhotonView_0;
        ...
        {
            MelonLogger.Msg("Troll->UnAppear: Triggered", 1);
            PhotonView photonView = Main.ghostAI.field_Public_PhotonView_0;
            photonView.RPC("MakeGhostAppear", RpcTarget.All, getRPCObject(2, false, 0, 1));
        }
        public static void Interact()
        {
            MelonLogger.Msg("Troll->Interact: Triggered", 1);
        ...
        public static void LockDoors(int lockState, int howMany = 0)
        {
            switch (lockState)
            {
                case 1:
                    CloseAllExitDoors();
                    MelonLogger.Msg("Troll->CloseAllExitDoors", 1);
                    break;
                case 2:
                    CloseAllRoomDoors();
                    MelonLogger.Msg("Troll->CloseAllRoomDoors", 1);
                    break;
                case 3:
                    OpenAllExitDoors();
                    MelonLogger.Msg("Troll->OpenAllExitDoors", 1);
                    break;
                case 4:
                    OpenAllRoomDoors();
                    MelonLogger.Msg("Troll->OpenAllRoomDoors", 1);
                    break;
                default:
                    break;
            }
        ...
        {
            MelonLogger.Msg("Troll->FuseBox: Triggered", 1);
        ...
        {
            MelonLogger.Msg("Troll->Event: Door knock", 1);
